...
namespace ChargingManagement_NguyenViet.Pages
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        {                        
            ...
            if (userAccount != null)
            {
                // Block role 4 from accessing the system
                if (userAccount.UserRole == 4)
                {
                    TempData["Message"] = "Access denied. Your account does not have permission to access this system.";
